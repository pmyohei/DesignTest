...
public class TimeGraghView extends View {
    ...
    public TimeGraghView(Context context) {
        this(context, null);
    }

    public TimeGraghView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimeGraghView(Context context, AttributeSet attrs, int defStyle) {
